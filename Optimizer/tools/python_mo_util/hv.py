...
class HyperVolume:
    ...
    def compute(self, front):
        ...
        hyperVolume = self.hvRecursive(
            dimensions - 1, len(relevantPoints), bounds)
        return hyperVolume
        ...
        if length == 0:
            ...
            while p is not sentinel:
                ...
                if q.ignore >= dimIndex:
                    ...
                    q.area[dimIndex] = hvRecursive(
                        dimIndex - 1, length, bounds)
...
if __name__ == "__main__":
    ...
    lst = [[1, 0, 2], [2, 0, 0], [0, 1.5, 1.5], [3, 3, 3]]
    front = [np.array(l) for l in lst]
